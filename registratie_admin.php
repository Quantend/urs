...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($Medewerkers_ID) || empty($Datum) || empty($Type_werkzaamheden) || empty($Start_tijd) || empty($Eind_tijd) || empty($Gewerkte_uren) || empty($Opdracht)) {
        ...
        if ($conn->query($sql) === TRUE) {
            ...
            header("refresh:4;url=registratie_admin.php");
        } else {
...
<body>
    <nav>
        ...
        <ul>
            ...
            <li><a class="active" href="registratie_admin.php">Uren Registreren</a></li>
    ...
    <main id="main_reg">
        <form method="post" id="registratie-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            Medewerkers ID:<input min="1" value="<?php echo $Medewerkers_ID; ?>" type="number" name="Medewerkers_ID"><br>
